    ...
    <div id="wrapper">
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <?php if (
                ...
                check_root_hak_akses('master_data_kategori_transaksi') == true
            ) { ?>
                <li class="nav-item <?= $this->uri->segment(1) == 'master_data' ? 'active' : '' ?>">
                    ...
                    <div id="collapseMasterData" class="collapse <?= $this->uri->segment(1) == 'master_data' ? 'show' : '' ?>" aria-labelledby="headingMasterData" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <?php } ?>
                            <?php if (check_root_hak_akses('master_data_kategori_transaksi') == true) { ?>
                                <a class="collapse-item <?= $this->uri->segment(1) == 'master_data' && $this->uri->segment(2) == 'kategori_transaksi' ? 'active' : '' ?>" href="<?= base_url('master_data/kategori_transaksi') ?>">Kategori Transaksi</a>
                            <?php } ?>
                        </div>
                    </div>
                </li>

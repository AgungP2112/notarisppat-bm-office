    ...
    <script>
        ...
        function loadTableMaster() {
            tableMaster = $('#tableMaster').DataTable({
                ...
                order: [],
                ajax: {
                    url: '<?= base_url('pengaturan/jabatan/load/table/main') ?>',
                    type: "POST"
                },
                keys: true,
                select: true,
            ...
            if (checkHakAkses('pengaturan_jabatan__delete') == 'true') {
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: '<?= base_url('pengaturan/jabatan/process/delete') ?>',
                            dataType: 'json',
                            data: {
                                jabatan_id: id
                            },
                ...
                alert(forbiddenAccess('pengaturan_jabatan__delete'));
            };
        };
    </script>
<?php } ?>
    ...
    <script>
        function processDeleteBatch() {
            if (checkHakAkses('pengaturan_jabatan__delete_batch') == 'true') {
                ...
                if (checkBox.length > 1) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                type: "POST",
                                url: '<?= base_url('pengaturan/jabatan/process/delete_batch') ?>',
                                dataType: 'json',
                                data: {
                                    id: dataList
                                },
                ...
                alert(forbiddenAccess('pengaturan_jabatan__delete_batch'));
            }
        };
    </script>
<?php } ?>

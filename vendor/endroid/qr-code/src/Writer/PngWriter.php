...
class PngWriter extends AbstractWriter
{
    public function writeString(QrCodeInterface $qrCode): string
    {
        ...
        if (null !== $logoPath) {
            $image = $this->add_logo($image, $logoPath, $qrCode->getLogoWidth(), $qrCode->getLogoHeight());
        }
     ...
     * @return mixed
     */
    private function add_logo($sourceImage, string $logoPath, int $logoWidth = null, int $logoHeight = null)
    {
